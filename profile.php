                                ...
                                <div class="mail">
                                    ...
                                    <div class="agile_mail_grids">
                                        <div class="col-md-4 contact-left">
                                            <h4>Address</h4>
                                            <p>HARAPAN INDAH BEKASI 
                                                <span> JAWA BAART</span></p>
                                            <ul>
                                                <li>WHATSAPP :+628378493827</li>
                                                <li>Telephone :+628378493827</li>
                                                <li>Fax :+628378493827</li>
                                                <li><a href="mailto:info@example.com">Electronicsite@gmail.com</a></li>
                                            </ul>
                                        </div>
