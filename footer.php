...
<div class="footer">
    <div class="container">
        <div class="w3_footer_grids">
            <div class="col-md-3 w3_footer_grid">
                <h3>Contact</h3>
                <p>OUR Sales promotion
                    Nadiya (0829138784231)
                    Dalton (0872363616373)
					 </p>
                <ul class="address">
    ...
    <div class="footer-copy">
        ...
        <div class="container">
            ...
            <p>&copy; <?php echo date('y-m-d');?> Electronic Store. All rights reserved | Design by teammz </p>
        </div>
    </div>
</div>
</body>
